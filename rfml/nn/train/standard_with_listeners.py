...
from .printing_training_listener import PrintingTrainingListener
from rfml.data import Dataset, Encoder
from rfml.nn.model import Model


class StandardWithListeners(TrainingStrategy):
    """A typical strategy that would be used to train a multi-class classifier including listeners.
    ...
    def __init__(
        ...
        self.register_listener(PrintingTrainingListener.on_epoch_completed)
        self.register_listener(PrintingTrainingListener.on_validation_completed)
        self.register_listener(PrintingTrainingListener.on_training_completed)
